...
$string['alexaskill_courseslotvalues_desc'] = '<p>Copy the list of course names below, formatted according to the course regular expression above, and paste into the Alexa developer console COURSE slot configuration:</p>';
